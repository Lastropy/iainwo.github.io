...
Over the week, I did these three micro-courses:
...
I also took a couple minutes to read a page on,
- [x] Hyperparameter Optimization
    ...
    - Population Based
- [x] Stochastic Gradient Descent (SGD) & Rectified Linear Unit (Relu)
    - Leaky ReLu
    - Creating non-linear systems using ReLu
